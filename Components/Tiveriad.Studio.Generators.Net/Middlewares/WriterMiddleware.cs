...
public class WriterMiddleware: IMiddleware<PipelineModel, PipelineContext, PipelineConfiguration>, IProcessor
{
    public void Run(PipelineContext context, PipelineModel model)
    {
        ...
        using var stream =  assembly.GetManifestResourceStream("Tiveriad.Studio.Generators.Net.Projects.ProjectTemplate.xml");
        ...
        foreach (var sourceItem in sourceItems)
            writer.Export(
                content: sourceItem.Source.NormalizeWhitespace(),
