...
namespace Tiveriad.Studio.Generators.Builders
{
    ...
    /// <b>not</b> immutable.
    /// </summary>
    public class InterfaceBuilder  : AbstractBuilder
    {
        ...
        {
            Interface = Interface.Set(accessModifier: Option.Some(accessModifier));
            return this;
        }
        ...
        public InterfaceBuilder WithName(string name)
        {
            ...
            Interface = Interface.Set(name: Option.Some(name));
            return this;
        }
        ...
        public InterfaceBuilder WithNamespace(string @namespace)
        {
            ...
            Interface.Set(@namespace: Option.Some(@namespace));
            return this;
        }
        ...
        /// </exception>
        public InterfaceBuilder WithExtentedInterface(Interface @interface)
        {
            ...
            Interface.ExtentedInterfaces.Add(@interface);
            return this;
        }
        ...
        /// </exception>
        public InterfaceBuilder WithExtendedInterfaces(IEnumerable<Interface> interfaces)
        {
            ...
            Interface.ExtentedInterfaces.AddRange(interfaces);
            return this;
        }
        ...
        /// One of the specified <paramref name="interfaces"/> is <c>null</c> or empty.
        /// </exception>
        public InterfaceBuilder WithExtendedInterfaces(params Interface[] interfaces)
        {
            if (interfaces is null)
                throw new ArgumentNullException(nameof(interfaces));
        ...
        public InterfaceBuilder WithSummary(string summary)
        {
            ...
            Interface = Interface.Set(summary: Option.Some(summary));
            return this;
        }
