...
namespace Tiveriad.Studio.Generators.Builders
{
    ...
    /// immutable.
    /// </summary>
    public class EnumMemberBuilder  : AbstractBuilder
    {
        ...
        public EnumMemberBuilder WithName(string name)
        {
            ...
            EnumerationMember = EnumerationMember.Set(name: Option.Some(name));
            return this;
        }
        ...
        {
            EnumerationMember = EnumerationMember.Set(value: value.ToOption());
            return this;
        }
        ...
        public EnumMemberBuilder WithSummary(string summary)
        {
            ...
            EnumerationMember = EnumerationMember.Set(summary: Option.Some(summary));
            return this;
        }
